...
public interface PckPackageInfoMapper {
     ...
     * @mbg.generated
     */
    PckPackageInfo selectByPrimaryKeyWithLogicalDelete(@Param("pckId") Integer pckId, @Param("andLogicalDeleted") boolean andLogicalDeleted);
     ...
     * @mbg.generated
     */
    int logicalDeleteByExample(@Param("example") PckPackageInfoExample example);
     ...
     * @mbg.generated
     */
    int logicalDeleteByPrimaryKey(Integer pckId);
}