        ...
        <el-row :gutter="10">
          <div style="margin-left: 2%;margin-bottom: 2%">
              ...
              >修改</el-button>
                ...
                <el-button icon="el-icon-refresh"  style="float: right;margin-right: 10%" size="mini" @click="resetForm('queryForm')">Reset</el-button>
                <el-button type="primary" style="float: right" icon="el-icon-search" size="mini" @click="handleQuery">Search</el-button>
...
<!--          </el-col>-->
      ...
      <el-table :data="productList" @row-click="redirect" v-loading="loading"  @selection-change="handleSelectionChange">
        ...
        <el-table-column label="Create Time" align="center" prop="createTime" width="100" :show-overflow-tooltip="true">
          <template slot-scope="scope">
            <span>{{ parseTime(scope.row.createTime) }}</span>
          </template>
        </el-table-column>

        <el-table-column label="Last Update Time" align="center" prop="lastUpdateTime" width="100" :show-overflow-tooltip="true">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="100">
          <template slot-scope="scope">
            <el-button v-if="scope.row.prostate == 'In Shelf'" size="small" type="success" @click.stop="OnOutShelf(scope.row.proId,'Off Shelf')">Off Shelf</el-button>
            <el-button v-else type="primary" size="small" @click.stop="OnOutShelf(scope.row.proId,'In Shelf')">Put Shelf</el-button>
          </template>
        </el-table-column>
